    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('borrower', 'Borrower'), ('lending_company', 'Lending Company')], default='borrower', max_length=20)),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('manager', 'Manager'), ('employee', 'Employee'), ('borrower', 'Borrower')], default='borrower', max_length=20)),
